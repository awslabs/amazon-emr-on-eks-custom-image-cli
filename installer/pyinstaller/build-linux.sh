...
mkdir -p .build_linux/output/amazon-emr-on-eks-custom-image-test-src
...
rm Makefile
cd ..
cp -r ./src/* ./output/amazon-emr-on-eks-custom-image-test-src
...
cd ..
zip -r "$binary_zip_filename" amazon-emr-on-eks-custom-image-test-src
